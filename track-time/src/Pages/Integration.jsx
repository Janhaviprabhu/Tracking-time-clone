import { Box,  Heading, Input,Text ,Image} from "@chakra-ui/react";
...
export const Integration=()=>{
    return (
      <>
        ...
        <br />
        <Box className="des">
          <Heading letterSpacing={3} as={"h3"} size="md">
            TRACKING TIME BUTTON FOR CHROME
          </Heading>
          <br />
          <Box className="h1">
            <Heading letterSpacing={3} as={"h1"} size="3xl">
          ...
          <br />
          <Input width={"57%"} placeHolder="SEARCH YOUR FAVOURITE APP!" />{" "}
          <br />
          <br />
          <Text>
        ...
        <div className="outer-div">
          <div>
            <Box className="img-box">
              <Image
                className="app-img"
                src="https://trackingtime.co/wp-content/themes/trackingtime-v4/img/temp/logos/airtable.png"
              />
            </Box>{" "}
            <br />
            ...
            <br />
            <Text color={"#7f8488"}>
              Powerful organizational spreadsheets that works exactly the way
              you want.
            </Text>
          </div>
          <div>
